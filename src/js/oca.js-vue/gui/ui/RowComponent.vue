<template>
    <div class="mt-2">
        ...
        <div class="row rowItem" v-if="!section.isDynamic">
            <control-component v-for="control in section.row.controls"
                               :key="control.name"
                               :control="control"
                               :label-position="section.labelPosition">
            </control-component>
...
<script>
    import {FormHandler} from "../../../oca.js-vue/gui/handler/form_handler";
