    ...
    <div class="row">
      <div class="col">
        <div class="q-pa-md row items-start q-gutter-md">
          <FlipCard v-for="(credential, i) in credentials">
              ...
              <q-card-section horizontal>
                <div class="q-pa-md">
                  <div class="q-gutter-y-md" style="min-width:300px; max-width:400px">
                      ...
                      <q-separator />
                      <q-tab-panels v-model="tab[i]" animated>
...
export default {
  ...
  data () {
    return {
      tab: Array(this.list.length).fill("scan"),
      search: "",
      expanded_items:[],
  ...
  methods: {
    ...
    */
    generatePreview: async function(credentialEl) {
      ...
      if (credential.credentialSubject.oca_schema_dri) {
